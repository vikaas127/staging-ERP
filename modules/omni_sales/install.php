...
if (!$CI->db->table_exists(db_prefix() . 'amazon_store')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "amazon_store` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `name` varchar(250) NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'amazon_store_detailt')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "amazon_store_detailt` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `group_product_id` int(11) NOT NULL,
    `product_id` int(11) NOT NULL,
    `amazon_store_id` int(11) NOT NULL,
    `prices` decimal(15,2) NOT NULL
    PRIMARY KEY (`id`)
  ) ENGINE=InnoDB DEFAULT CHARSET=" . $CI->db->char_set . ';');
}

if (!$CI->db->table_exists(db_prefix() . 'flipkart_store')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "flipkart_store` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `name` varchar(250) NOT NULL,
    `ip` varchar(30) NOT NULL,
    `url` varchar(100) NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'flipkart_store_detailt')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "flipkart_store_detailt` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `group_product_id` int(11) NOT NULL,
    `product_id` int(11) NOT NULL,
    `flipkart_store_id` int(11) NOT NULL,
    `prices` decimal(15,2) NOT NULL
    PRIMARY KEY (`id`)
  ) ENGINE=InnoDB DEFAULT CHARSET=" . $CI->db->char_set . ';');
}

if (!$CI->db->table_exists(db_prefix() . 'myntra_store')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "myntra_store` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `name` varchar(250) NOT NULL,
    `ip` varchar(30) NOT NULL,
    `url` varchar(100) NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'myntra_store_detailt')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "myntra_store_detailt` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `group_product_id` int(11) NOT NULL,
    `product_id` int(11) NOT NULL,
    `myntra_store_id` int(11) NOT NULL,
    `prices` decimal(15,2) NOT NULL
    PRIMARY KEY (`id`)
  ) ENGINE=InnoDB DEFAULT CHARSET=" . $CI->db->char_set . ';');
}

if (!$CI->db->table_exists(db_prefix() . 'omni_log_sync_flipkart')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "omni_log_sync_flipkart` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `name` varchar(250) NOT NULL,
    `regular_price` int(11) NOT NULL,
    `sale_price` int(11) NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'omni_log_sync_amazon')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "omni_log_sync_amazon` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `name` varchar(250) NOT NULL,
    `regular_price` int(11) NOT NULL,
    `sale_price` int(11) NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'omni_log_sync_myntra')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "omni_log_sync_myntra` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `name` varchar(250) NOT NULL,
    `regular_price` int(11) NOT NULL,
    `sale_price` int(11) NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'omni_master_channel_flipkart')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "omni_master_channel_flipkart` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `name_channel` text NOT NULL,
    `consumer_key` text NOT NULL,
    `consumer_secret` text NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'omni_master_channel_amazon')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "omni_master_channel_amazon` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `name_channel` text NOT NULL,
    `consumer_key` text NOT NULL,
    `consumer_secret` text NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'omni_master_channel_myntra')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "omni_master_channel_myntra` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `name_channel` text NOT NULL,
    `consumer_key` text NOT NULL,
    `consumer_secret` text NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'orders_amazon')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "orders_amazon` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
...
if (!$CI->db->table_exists(db_prefix() . 'orders_flipkart')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "orders_flipkart` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `order_id` varchar(50) NOT NULL,
    `item_ids` int(11) NOT NULL,
    `store_id` int(11) NOT NULL,
...
if (!$CI->db->table_exists(db_prefix() . 'orders_myntra')) {
  $CI->db->query('CREATE TABLE `' . db_prefix() . "orders_myntra` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `order_id` varchar(50) NOT NULL,
    `item_ids` int(11) NOT NULL,
    `store_id` int(11) NOT NULL,
