...
class Omni_sales_model extends App_Model
{
	 ...
	 * @return  object or array object        
	 */
	public function get_group_orders($id = ''){
		if($id != ''){
			$this->db->where('id',$id);
			return $this->db->get(db_prefix().'items_groups')->row();
		}
	...
	/**
	 *  delete_product_flipkart 
	 * @param   int $id   
	 * @return  bool       
	 */
	public function delete_product_flipkart($id){
		$this->db->where('id',$id);
		$this->db->delete(db_prefix().'sales_channel_detailt');
		if ($this->db->affected_rows() > 0) {           
			return true;
	...
	/**
	 *  add channel flipkart   
	 * @param  array  $data 
	 * @return  int $insert_id     
	 */
	public function add_channel_flipkart($data){
		$this->db->insert('omni_master_channel_flipkart', $data);
		$insert_id = $this->db->insert_id();
		return $insert_id;
	}
	/**
	 *  update channel flipkart  
	 * @param   array  $data   
	 * @param   int  $id     
	 * @return  bool          
	 */
	public function update_channel_flipkart($data, $id){
		$this->db->where('id', $id);
		$this->db->update(db_prefix() . 'omni_master_channel_flipkart', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	 ...
	 * @return  int $insert_id     
	 */
	public function add_channel_myntra($data){
		$this->db->insert('omni_master_channel_myntra', $data);
		$insert_id = $this->db->insert_id();
		return $insert_id;
	}
	 ...
	 * @return  int $insert_id     
	 */
	public function add_channel_amazon($data){
		$this->db->insert('omni_master_channel_amazon', $data);
		$insert_id = $this->db->insert_id();
		return $insert_id;
	}
	/**
	 ...
	 * @return  bool          
	 */
	public function update_channel_myntra($data, $id){
		$this->db->where('id', $id);
		$this->db->update(db_prefix() . 'omni_master_channel_myntra', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	...
	/**
	 *  update channel amazon  
	 * @param   array  $data   
	 * @param   int  $id     
	 * @return  bool          
	 */
	public function update_channel_amazon($data, $id){
		$this->db->where('id', $id);
		$this->db->update(db_prefix() . 'omni_master_channel_amazon', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	...
	/**
	 *  delete channel amazon   
	 * @param   int  $id    
	 * @return  bool         
	 */
	public function delete_channel_amazon($id){
		$this->db->where('id',$id);
		$this->db->delete(db_prefix().'omni_master_channel_amazon');
		if ($this->db->affected_rows() > 0) {           
			return true;
		}
		return false;
	...
	/**
	 *  delete channel flipkart   
	 * @param   int  $id    
	 * @return  bool         
	 */
	public function delete_channel_flipkart($id){
		$this->db->where('id',$id);
		$this->db->delete(db_prefix().'omni_master_channel_flipkart');
		if ($this->db->affected_rows() > 0) {           
			return true;
		}
		return false;
	...
	/**
	 *  delete channel myntra   
	 * @param   int  $id    
	 * @return  bool         
	 */
	public function delete_channel_myntra($id){
		$this->db->where('id',$id);
		$this->db->delete(db_prefix().'omni_master_channel_myntra');
		if ($this->db->affected_rows() > 0) {           
			return true;
		}
		return false;
	...
	/**
	 *  add product channel flipkart   
	 * @param  array  $data 
	 * @return  int insert_id      
	 */
	public function add_product_channel_fkt($data){
		$insert_id = 0;
		if(isset($data[0])){
			$data['flipkart_store_id'] =  implode($data[0]);
			$data['group_product_id'] =  implode($data[1]);
			$data['prices'] =  implode($data[3]);
			$data['product_id'] =  $data[2];
			unset($data[0]);
		...
		if($data['group_product_id'] && empty($data['product_id'])){
			...
			foreach ($items as $key => $value) {
				...
				$data_add['flipkart_store_id'] = $data['flipkart_store_id'];
				$data_add['group_product_id'] = $data['group_product_id'];
				$data_add['product_id'] = $value['id'];
				$data_add['prices'] = $prices;
				$data_saved = $this->get_product_channel($value['id'],$data['flipkart_store_id']);
				if($data_saved){
					$this->db->where('id', $data_saved->id);
					$this->db->update('flipkart_store_detailt', $data_add);
				}
				else{
					$this->db->insert('flipkart_store_detailt', $data_add);
				}
				$insert_id = 1;     
			}
			return $insert_id;
		...
		foreach ($data['product_id'] as $key => $value) {
			...
			$data_add['product_id'] = $value;
			$data_add['prices'] = $prices;
			$data_saved = $this->get_flipkart_store_detailt($value,$data['flipkart_store_id']);
			if($data_saved){
				$this->db->where('id', $data_saved->id);
				$this->db->update('flipkart_store_detailt', $data_add);
				$this->process_price_synchronization_update_product_flipkart($data_add['flipkart_store_id'], $data_add['prices'], $data_add['product_id']);
			}
			else{
				$this->db->insert('flipkart_store_detailt', $data_add);
			}
	...
	/**
	 *  add product channel myntra   
	 * @param  array  $data 
	 * @return  int insert_id      
	 */
	public function add_product_channel_myntra($data){
		$insert_id = 0;
		if(isset($data[0])){
			$data['myntra_store_id'] =  implode($data[0]);
			$data['group_product_id'] =  implode($data[1]);
			$data['prices'] =  implode($data[3]);
			$data['product_id'] =  $data[2];
			unset($data[0]);
		...
		if($data['group_product_id'] && empty($data['product_id'])){
			...
			foreach ($items as $key => $value) {
				...
				$data_add['myntra_store_id'] = $data['myntra_store_id'];
				$data_add['group_product_id'] = $data['group_product_id'];
				$data_add['product_id'] = $value['id'];
				$data_add['prices'] = $prices;
				$data_saved = $this->get_product_channel($value['id'],$data['myntra_store_id']);
				if($data_saved){
					$this->db->where('id', $data_saved->id);
					$this->db->update('myntra_store_detailt', $data_add);
				}
				else{
					$this->db->insert('myntra_store_detailt', $data_add);
				}
				$insert_id = 1;     
			}
			return $insert_id;
		...
		foreach ($data['product_id'] as $key => $value) {
			...
			$data_add['product_id'] = $value;
			$data_add['prices'] = $prices;
			$data_saved = $this->get_myntra_store_detailt($value,$data['myntra_store_id']);
			if($data_saved){
				$this->db->where('id', $data_saved->id);
				$this->db->update('myntra_store_detailt', $data_add);
				$this->process_price_synchronization_update_product_myntra($data_add['myntra_store_id'], $data_add['prices'], $data_add['product_id']);
			}
			else{
				$this->db->insert('myntra_store_detailt', $data_add);
			}
	...
	/**
	 *  add product channel amazon   
	 * @param  array  $data 
	 * @return  int insert_id      
	 */
	public function add_product_channel_amazon($data){
		$insert_id = 0;
		if(isset($data[0])){
			$data['amazon_store_id'] =  implode($data[0]);
			$data['group_product_id'] =  implode($data[1]);
			$data['prices'] =  implode($data[3]);
			$data['product_id'] =  $data[2];
			unset($data[0]);
		...
		if($data['group_product_id'] && empty($data['product_id'])){
			...
			foreach ($items as $key => $value) {
				...
				$data_add['amazon_store_id'] = $data['amazon_store_id'];
				$data_add['group_product_id'] = $data['group_product_id'];
				$data_add['product_id'] = $value['id'];
				$data_add['prices'] = $prices;
				$data_saved = $this->get_product_channel($value['id'],$data['amazon_store_id']);
				if($data_saved){
					$this->db->where('id', $data_saved->id);
					$this->db->update('amazon_store_detailt', $data_add);
				}
				else{
					$this->db->insert('amazon_store_detailt', $data_add);
				}
				$insert_id = 1;     
			}
			return $insert_id;
		...
		foreach ($data['product_id'] as $key => $value) {
			...
			$data_add['product_id'] = $value;
			$data_add['prices'] = $prices;
			$data_saved = $this->get_amazon_store_detailt($value,$data['amazon_store_id']);
			if($data_saved){
				$this->db->where('id', $data_saved->id);
				$this->db->update('amazon_store_detailt', $data_add);
				$this->process_price_synchronization_update_product_amazon($data_add['amazon_store_id'], $data_add['prices'], $data_add['product_id']);
			}
			else{
				$this->db->insert('amazon_store_detailt', $data_add);
			}
	...
	/**
	 *  get_flipkart_store_detailt 
	 * @param   int  $product_id           
	 * @param   int  $flipkart_store_id  
	 * @return  object                        
	 */
	public function get_flipkart_store_detailt($product_id, $flipkart_store_id, $return_array = false){
		$this->db->where('product_id', $product_id);
		$this->db->where('flipkart_store_id', $flipkart_store_id);
		if($return_array == false){
			return $this->db->get('flipkart_store_detailt')->row();
		}else{
			return $this->db->get('flipkart_store_detailt')->result_array();
		}
	}

	/**
	 *  get_myntra_store_detailt 
	 * @param   int  $product_id           
	 * @param   int  $flipkart_store_id  
	 * @return  object                        
	 */
	public function get_myntra_store_detailt($product_id, $flipkart_store_id, $return_array = false){
		$this->db->where('product_id', $product_id);
		$this->db->where('myntra_store_id', $flipkart_store_id);
		if($return_array == false){
			return $this->db->get('myntra_store_detailt')->row();
		}else{
			return $this->db->get('myntra_store_detailt')->result_array();
		}
	}

	/**
	 *  get_amazon_store_detailt 
	 * @param   int  $product_id           
	 * @param   int  $amazon_store_id  
	 * @return  object                        
	 */
	public function get_amazon_store_detailt($product_id, $amazon_store_id, $return_array = false){
		$this->db->where('product_id', $product_id);
		$this->db->where('amazon_store_id', $flipkart_store_id);
		if($return_array == false){
			return $this->db->get('amazon_store_detailt')->row();
		}else{
			return $this->db->get('amazon_store_detailt')->result_array();
		}
	}
	 ...
	 * @return  object         
	 */
	public function get_flipkart_store($id = ''){
		if($id != ''){
			$this->db->where('id', $id);
			return $this->db->get(db_prefix().'omni_master_channel_flipkart')->row();
		}else{
			return $this->db->get(db_prefix().'omni_master_channel_flipkart')->result_array();
		}
	}
	 ...
	 * @return  object         
	 */
	public function get_myntra_store($id = ''){
		if($id != ''){
			$this->db->where('id', $id);
			return $this->db->get(db_prefix().'omni_master_channel_myntra')->row();
		}else{
			return $this->db->get(db_prefix().'omni_master_channel_myntra')->result_array();
		}
	}
	 ...
	 * @return  object         
	 */
	public function get_amazon_store($id = ''){
		if($id != ''){
			$this->db->where('id', $id);
			return $this->db->get(db_prefix().'omni_master_channel_amazon')->row();
		}else{
			return $this->db->get(db_prefix().'omni_master_channel_amazon')->result_array();
		}
	}
	...
	/**
	 * sync order flipkart system
	 * @param  int $store_id 
	 * @return string           
	 */
	public function sync_order_flipkart_system($store_id){
		$woocommerce = $this->init_connect_flipkart($store_id);
		$per_page = 100;
		$order = [];
		for($page = 1; $page <= $this->per_page_tags; $page++ ){
			$offset = ($page - 1) * $per_page;
	...
	/**
	 * sync order myntra system
	 * @param  int $store_id 
	 * @return string           
	 */
	public function sync_order_myntra_system($store_id){
		$woocommerce = $this->init_connect_myntra($store_id);
		$per_page = 100;
		$order = [];
		for($page = 1; $page <= $this->per_page_tags; $page++ ){
			$offset = ($page - 1) * $per_page;
	...
	/**
	 * sync order amamzon system
	 * @param  int $store_id 
	 * @return string           
	 */
	public function sync_order_amazon_system($store_id){
		$woocommerce = $this->init_connect_amazon($store_id);
		$per_page = 100;
		$order = [];
		for($page = 1; $page <= $this->per_page_tags; $page++ ){
			$offset = ($page - 1) * $per_page;
	...
	/**
	 * process orders flipkart
	 * @param  int $store_id 
	 * @return bool           
	 */
	public function process_orders_flipkart($store_id){
		$this->load->model('clients_model');
		$this->load->model('emails_model');
		$password = $this->generate_string();
		$store  = $this->get_flipkart_store($store_id);
		$woocommerce = $this->init_connect_flipkart($store_id);
		if($store && $woocommerce){
			$store_name = $store->name_channel;
			$data = $this->sync_order_flipkart_system($store_id);
	...
	/**
	 * process orders myntra
	 * @param  int $store_id 
	 * @return bool           
	 */
	public function process_orders_myntra($store_id){
		$this->load->model('clients_model');
		$this->load->model('emails_model');
		$password = $this->generate_string();
		$store  = $this->get_myntra_store($store_id);
		$woocommerce = $this->init_connect_myntra($store_id);
		if($store && $woocommerce){
			$store_name = $store->name_channel;
			$data = $this->sync_order_myntra_system($store_id);
	...
	/**
	 * process orders amazon
	 * @param  int $store_id 
	 * @return bool           
	 */
	public function process_orders_amazon($store_id){
		$this->load->model('clients_model');
		$this->load->model('emails_model');
		$password = $this->generate_string();
		$store  = $this->get_amazon_store($store_id);
		$woocommerce = $this->init_connect_amazon($store_id);
		if($store && $woocommerce){
			$store_name = $store->name_channel;
			$data = $this->sync_order_amazon_system($store_id);
	 ...
	 * add order flipkart
	 */
	public function add_order_flipkart($data, $woocommerce, $store_id, $store_name){
		$productid_list = [];
		$taxes_list = [];
		$prices = [];
		$quantity_list = [];
		...
		if($cart_after_insert && is_object($cart_after_insert)){
			...
			$this->db->insert(db_prefix().'omni_log_sync_flipkart', $log_orders);
		}
	}
	 ...
	 * add order myntra
	 */
	public function add_order_myntra($data, $woocommerce, $store_id, $store_name){
		$productid_list = [];
		$taxes_list = [];
		$prices = [];
		$quantity_list = [];
		...
		if($cart_after_insert && is_object($cart_after_insert)){
			...
			$this->db->insert(db_prefix().'omni_log_sync_myntra', $log_orders);
		}
	}
	 ...
	 * add order amazon
	 */
	public function add_order_amazon($data, $woocommerce, $store_id, $store_name){
		$productid_list = [];
		$taxes_list = [];
		$prices = [];
		$quantity_list = [];
		...
		if($cart_after_insert && is_object($cart_after_insert)){
			...
			$this->db->insert(db_prefix().'omni_log_sync_amazon', $log_orders);
		}
	}
...
public function get_discount($id = ''){
	...
	/**
	 *  delete_product_amazon
	 * @param   int $id   
	 * @return  bool       
	 */
	public function delete_product_store_amazon($store, $id){
		$this->db->where('id',$id);
		$this->db->where('amazon_store_id',$store);
		$this->db->delete(db_prefix().'amazon_store_detailt');
		if ($this->db->affected_rows() > 0) {           
			return true;
		}
		return false;
	 ...
	 * @return  bool       
	 */
	public function delete_product_store_flipkart($store, $id){
		$this->db->where('id',$id);
		$this->db->where('flipkart_store_id',$store);
		$this->db->delete(db_prefix().'flipkart_store_detailt');
		if ($this->db->affected_rows() > 0) {           
			return true;
		}
		return false;
	...
	/**
	 *  delete_product_myntra
	 * @param   int $id   
	 * @return  bool       
	 */
	public function delete_product_store_myntra($store, $id){
		$this->db->where('id',$id);
		$this->db->where('myntra_store_id',$store);
		$this->db->delete(db_prefix().'myntra_store_detailt');
		if ($this->db->affected_rows() > 0) {           
			return true;
		}
		return false;
	...
	* @return        
	*/
	public function test_connect_myntra($data)
	{
		$consumer_key = $data['consumer_key'];
		$consumer_secret = $data['consumer_secret'];
	...
	* @return        
	*/
	public function test_connect_amazon($data)
	{
		$consumer_key = $data['consumer_key'];
		$consumer_secret = $data['consumer_secret'];
		$refresh_token = $data['refresh_token'];
	...
	/**
	* test connect flipkart
	* @param   $data 
	* @return        
	*/
	public function test_connect_flipkart($data)
	{
		$consumer_key = $data['consumer_key'];
		$consumer_secret = $data['consumer_secret'];
		$refresh_token = $data['refresh_token'];
	...
	*/
	...
	public function get_name_store_flipkart($store_id){
		$this->db->where('id', $store_id);
		if($this->db->get(db_prefix().'omni_master_channel_flipkart')->row()->name_channel){
			$this->db->where('id', $store_id);
			return $this->db->get(db_prefix().'omni_master_channel_flipkart')->row()->name_channel;
		}else{
			return "";
		}
	}
		...
		*/
		...
		/**
		* process price synchronization flipkart
		* @param  int $store_id 
		* @param  array $arr_detail 
		* @return bool           
		*/
		public function process_price_synchronization_flipkart($store_id, $arr_detail = null){
			$products_store = $this->get_product_parent_id();
			$date = date('Y-m-d');
			$items = [];
			if(isset($arr_detail)){
		...
		/**
		* process price synchronization myntra
		* @param  int $store_id 
		* @param  array $arr_detail 
		* @return bool           
		*/
		public function process_price_synchronization_myntra($store_id, $arr_detail = null){
			$products_store = $this->get_product_parent_id();
			$date = date('Y-m-d');
			$items = [];
			if(isset($arr_detail)){
				...
				if($value->sku != ''){
					foreach ($items as $item) {
						if($item->sku_code == $value->sku){
							...
							$this->db->insert(db_prefix().'omni_log_sync_myntra', $log_price);
						}
					}   
				}
			}
		...
		/**
		* process price synchronization amazon
		* @param  int $store_id 
		* @param  array $arr_detail 
		* @return bool           
		*/
		public function process_price_synchronization_amazon($store_id, $arr_detail = null){
			$products_store = $this->get_product_parent_id();
			$date = date('Y-m-d');
			$items = [];
			if(isset($arr_detail)){
				...
				if($value->sku != ''){
					foreach ($items as $item) {
						if($item->sku_code == $value->sku){
							...
							$this->db->insert(db_prefix().'omni_log_sync_amazon', $log_price);
						}
					}   
				}
			}
 ...
 * @return bool           
 */
public function process_price_synchronization_update_product_flipkart($store_id, $price, $product_id){

	$product = $this->get_product($product_id);

	$amazonInfo = $this->init_connect_myntra($store_id);

	$getMarketplaceInfo = $this->get_marketplace_amazon($amazonInfo['access_token']);

	if(isset($getMarketplaceInfo['payload']['marketplace'])){
		$getProducts = $this->get_listitems_amazon($getMarketplaceInfo['payload']['marketplace']['id']);
	}
	...
	foreach ($products_store as $key => $value) {
		...
		if($value->sku != ''){
			if($product->sku_code == $value->sku){
				...
				$this->db->insert(db_prefix().'omni_log_sync_flipkart', $log_price);
				$rs = $woocommerce->post('products/'.$value->id, $data);
			}
		}
	}
 ...
 * @return bool           
 */
public function process_price_synchronization_update_product_myntra($store_id, $price, $product_id){
	$product = $this->get_product($product_id);
 ...
 * @return bool           
 */
public function process_price_synchronization_update_product_amazon($store_id, $price, $product_id){
	$product = $this->get_product($product_id);

	$amazonInfo = $this->init_connect_amazon($store_id);
...
public function get_marketplace_amazon($accessToken){

	$curl = curl_init();

	curl_setopt_array($curl, array(
	  CURLOPT_URL => 'https://api.amazon.com/sellers/v1/marketplaceParticipations',
	  CURLOPT_RETURNTRANSFER => true,
	  CURLOPT_ENCODING => '',
	  CURLOPT_MAXREDIRS => 10,
	  CURLOPT_TIMEOUT => 0,
...
public function get_marketplace_flipkart($accessToken){

	$curl = curl_init();

	curl_setopt_array($curl, array(
	  CURLOPT_URL => 'https://api.flipkart.com/sellers/v1/marketplaceParticipations',
	  CURLOPT_RETURNTRANSFER => true,
	  CURLOPT_ENCODING => '',
	  CURLOPT_MAXREDIRS => 10,
	  CURLOPT_TIMEOUT => 0,
...
public function get_listitems_amazon($marketplace_id){

	$curl = curl_init();

	curl_setopt_array($curl, array(
	  CURLOPT_URL => 'https://sellingpartnerapi-na.amazon.com/catalog/2022-04-01/items?marketplaceIds='.$marketplace_id,
	  CURLOPT_RETURNTRANSFER => true,
	  CURLOPT_ENCODING => '',
	  CURLOPT_MAXREDIRS => 10,
	  CURLOPT_TIMEOUT => 0,
...
public function format_date_time($date){
   ...
   */
	...
	*/
	...
	/**
	 * process inventory synchronization flipkart
	 * @param  int $store_id 
	 * @return bool           
	 */
	public function process_inventory_synchronization_detail_flipkart($store_id, $arr_detail = null){
		$store =  $this->get_flipkart_store($store_id);
		$store_name = $store->name_channel;
		$products_store = $this->get_product_parent_id();
		$date = date('Y-m-d');
				...
				foreach ($items as $item) {
					if($item->sku_code == $value->sku){
						...
						if(!is_null($item->id)){
							...
							$regular_price = $this->get_price_store_flipkart($item->id, $store_id);
							if(!isset($regular_price->prices)){
								$regular_price_prices = 0;
							}else{
								$regular_price_prices = $regular_price->prices;
		...
		if(count($log_inventory) > 0){
			$this->db->insert_batch(db_prefix().'omni_log_sync_flipkart', $log_inventory);
		}
		return true;
	}

	/**
	 * process inventory synchronization myntra
	 * @param  int $store_id 
	 * @return bool           
	 */
	public function process_inventory_synchronization_detail_myntra($store_id, $arr_detail = null){
		$store =  $this->get_myntra_store($store_id);
		$store_name = $store->name_channel;
		$products_store = $this->get_product_parent_id();
		$date = date('Y-m-d');
		...
		if(count($log_inventory) > 0){
			$this->db->insert_batch(db_prefix().'omni_log_sync_myntra', $log_inventory);
		}
		return true;
	}

	/**
	 * process inventory synchronization amazon
	 * @param  int $store_id 
	 * @return bool           
	 */
	public function process_inventory_synchronization_detail_amazon($store_id, $arr_detail = null){
		$store =  $this->get_amazon_store($store_id);
		$store_name = $store->name_channel;
		$products_store = $this->get_product_parent_id();
		$date = date('Y-m-d');
		...
		if(count($log_inventory) > 0){
			$this->db->insert_batch(db_prefix().'omni_log_sync_amazon', $log_inventory);
		}
		return true;
	}
	...
	/**
	 * process images synchronization flipkart
	 * @param $store_id
	 */

	public function process_images_synchronization_detail_flipkart($store_id, $arr_detail = null){
		$items = [];
		$products_store = $this->get_product_parent_id();
	...
	/**
	 * process images synchronization myntra
	 * @param $store_id
	 */

	public function process_images_synchronization_detail_myntra($store_id, $arr_detail = null){
		$items = [];
		$products_store = $this->get_product_parent_id();
	...
	/**
	 * process images synchronization amazon
	 * @param $store_id
	 */

	 public function process_images_synchronization_detail_amazon($store_id, $arr_detail = null){
		$items = [];
		$products_store = $this->get_product_parent_id();
	...
	*/
	...
	/**
	 * process decriptions synchronization flipkart
	 * @param $store_id
	 * @return           
	*/
	public function process_decriptions_synchronization_detail_flipkart($store_id, $arr_detail = null){
		$items = [];
		$products_store = $this->get_product_parent_id();
			...
			if($value->sku != ''){
				foreach ($items as $item) {
					if($item->sku_code == $value->sku){
						...
						$this->db->insert(db_prefix().'omni_log_sync_flipkart', $log_product);
	...
	/**
	 * process decriptions synchronization myntra
	 * @param $store_id
	 * @return           
	*/
	public function process_decriptions_synchronization_detail_myntra($store_id, $arr_detail = null){
		$items = [];
		$products_store = $this->get_product_parent_id();
			...
			if($value->sku != ''){
				foreach ($items as $item) {
					if($item->sku_code == $value->sku){
						...
						$this->db->insert(db_prefix().'omni_log_sync_myntra', $log_product);
	...
	/**
	 * process decriptions synchronization amazon
	 * @param $store_id
	 * @return           
	*/
	public function process_decriptions_synchronization_detail_amazon($store_id, $arr_detail = null){
		$items = [];
		$products_store = $this->get_product_parent_id();
			...
			if($value->sku != ''){
				foreach ($items as $item) {
					if($item->sku_code == $value->sku){
						...
						$this->db->insert(db_prefix().'omni_log_sync_amazon', $log_product);
	 ...
	 * @return  bool       
	 */
	public function delete_product_store_all_flipkart($store, $id){
		$this->db->where('product_id',$id);
		$this->db->where('flipkart_store_id',$store);
		$this->db->delete(db_prefix().'flipkart_store_detailt');
		if ($this->db->affected_rows() > 0) {           
	 ...
	 * @return  bool       
	 */
	public function delete_product_store_all_myntra($store, $id){
		$this->db->where('product_id',$id);
		$this->db->where('myntra_store_id',$store);
		$this->db->delete(db_prefix().'myntra_store_detailt');
		if ($this->db->affected_rows() > 0) {           
	 ...
	 * @return  bool       
	 */
	public function delete_product_store_all_amazon($store, $id){
		$this->db->where('product_id',$id);
		$this->db->where('amazon_store_id',$store);
		$this->db->delete(db_prefix().'amazon_store_detailt');
		if ($this->db->affected_rows() > 0) {           
	 ...
	 * @return  object                        
	 */
	public function get_ids_flipkart_store_detailt($woocommere_store_id){
		$this->db->where('flipkart_store_id', $woocommere_store_id);
		$products = $this->db->get('flipkart_store_detailt')->result_array();
		$ids = [];
		foreach ($products as $product) {
			array_push($ids, $product['product_id']);
		}
	 ...
	 * @return  object                        
	 */
	public function get_ids_myntra_store_detailt($woocommere_store_id){
		$this->db->where('myntra_store_id', $woocommere_store_id);
		$products = $this->db->get('myntra_store_detailt')->result_array();
		$ids = [];
		foreach ($products as $product) {
			array_push($ids, $product['product_id']);
		}
	 ...
	 * @return  object                        
	 */
	public function get_ids_amazon_store_detailt($woocommere_store_id){
		$this->db->where('amazon_store_id', $woocommere_store_id);
		$products = $this->db->get('amazon_store_detailt')->result_array();
		$ids = [];
		foreach ($products as $product) {
			array_push($ids, $product['product_id']);
		}
	 ...
	 * @return          
	 */
	public function sync_all_flipkart($store_id, $product_ids = []){
		$woocommerce = $this->init_connect_flipkart($store_id);
		//get all products have variation include ids and sku_codes 
		$products_variation = $this->get_item_have_variation();
		$date = date('Y-m-d');
	 ...
	 * @return          
	 */
	public function sync_all_myntra($store_id, $product_ids = []){
		$woocommerce = $this->init_connect_myntra($store_id);
		//get all products have variation include ids and sku_codes 
		$products_variation = $this->get_item_have_variation();
		$date = date('Y-m-d');
	 ...
	 * @return          
	 */
	public function sync_all_amazon($store_id, $product_ids = []){
		$woocommerce = $this->init_connect_amazon($store_id);
		//get all products have variation include ids and sku_codes 
		$products_variation = $this->get_item_have_variation();
		$date = date('Y-m-d');
...
public function get_max_version_omni_customer_report($next_version = false)
{
	...
	/**
	 * [init_connect_flipkart description]
	 * @param  [type] $store_id [description]
	 * @return [type]           [description]
	 */
	public function init_connect_flipkart($store_id){

		$channel =  $this->get_flipkart_store($store_id);
		$consumer_key = $channel->consumer_key;
		$consumer_secret = $channel->consumer_secret;
		$url = $channel->url;
	...
	/**
	 * [init_connect_myntra description]
	 * @param  [type] $store_id [description]
	 * @return [type]           [description]
	 */
	public function init_connect_myntra($store_id){
		$channel =  $this->get_myntra_store($store_id);
		$consumer_key = $channel->consumer_key;
		$consumer_secret = $channel->consumer_secret;
		$url = $channel->url;
		$refresh_token = $channel->refresh_token;
	 ...
	 * @return [type]           [description]
	 */
	public function init_connect_amazon($store_id){
		$channel =  $this->get_amazon_store($store_id);
		$consumer_key = $channel->consumer_key;
		$consumer_secret = $channel->consumer_secret;
		$url = $channel->url;
		$refresh_token = $channel->refresh_token;
	 ...
	 * @return bool           
	 */
	public function sync_product_name_flipkart($store_id, $arr_detail = null){
		$store =  $this->get_product_parent_id($store_id);
		$store_name = $store->name_channel;
		$products_store = $this->get_product();
		 ...
		 */
	 	...
	 	/**
		 * sync short description flipkart
		 * @param $store_id
		 * @return           
		 */
	 	public function sync_short_description_flipkart($store_id, $product_ids = []){
		 	$items = [];
		 	if($product_ids != []){
	            $product_ids = implode(',', $product_ids);
		 		$this->db->where('id IN ('.$product_ids.')');
			...
			foreach ($items as $item) {
		 	...
		 	if(count($data_update_master) > 0){
		 		...
		 		if(count($logs) > 0){
					$this->db->insert_batch(db_prefix().'omni_log_sync_flipkart', $logs);
				}
		 	}
		 	return true;
	 	}
	 	...
	 	/**
		 * sync short description myntra
		 * @param $store_id
		 * @return           
		 */
	 	public function sync_short_description_myntra($store_id, $product_ids = []){
		 	$items = [];
		 	if($product_ids != []){
	            $product_ids = implode(',', $product_ids);
		 		$this->db->where('id IN ('.$product_ids.')');
		 		...
		 		$items = $this->get_list_product_store_myntra($store_id);
		 	}
			...
			foreach ($items as $item) {
		 	...
		 	if(count($data_update_master) > 0){
		 		...
		 		if(count($logs) > 0){
					$this->db->insert_batch(db_prefix().'omni_log_sync_myntra', $logs);
				}
		 	}
		 	return true;
	 	}
		...
		/**
		 * sync short description amazon
		 * @param $store_id
		 * @return           
		 */
		public function sync_short_description_amazon($store_id, $product_ids = []){
			$items = [];
			if($product_ids != []){
			   $product_ids = implode(',', $product_ids);
				$this->db->where('id IN ('.$product_ids.')');
				...
				$items = $this->get_list_product_store_amazon($store_id);
			}
		   ...
		   foreach ($items as $item) {
			...
			if(count($data_update_master) > 0){
				...
				if(count($logs) > 0){
				   $this->db->insert_batch(db_prefix().'omni_log_sync_amazon', $logs);
			   }
			}
			return true;
		}
...
public function create_invoice_detail_order($orderid, $status = '') {
   ...
   */
	...
	/**
	 * Update prices for store products flipkart
	 * @param  $store_id
	 * @param  $arr     
	 * @return boolean       
	 */
	public function fkt_price_update($store_id, $arr = null){
		if($arr != '' && $arr != null){
			$this->db->where(db_prefix().'flipkart_store_detailt.product_id IN (' . implode(', ', $arr) . ')');
		}
		$this->db->select('*, '.db_prefix().'flipkart_store_detailt.id as id');
		$this->db->where('flipkart_store_id', $store_id);
		$this->db->join(db_prefix() . 'items', db_prefix() . 'items.id = '.db_prefix() . 'flipkart_store_detailt.product_id','left');
		$products_store = $this->db->get(db_prefix().'flipkart_store_detailt')->result_array();
		foreach($products_store as $product){
			$this->db->where('id', $product['id']);
			$this->db->update(db_prefix().'flipkart_store_detailt', ['prices' => $product['rate']]);
		}
	...
	/**
	 * Update prices for store products Myntra
	 * @param  $store_id
	 * @param  $arr     
	 * @return boolean       
	 */
	public function myntra_price_update($store_id, $arr = null){
		if($arr != '' && $arr != null){
			$this->db->where(db_prefix().'myntra_store_detailt.product_id IN (' . implode(', ', $arr) . ')');
		}
		$this->db->select('*, '.db_prefix().'myntra_store_detailt.id as id');
		$this->db->where('flipkart_store_id', $store_id);
		$this->db->join(db_prefix() . 'items', db_prefix() . 'items.id = '.db_prefix() . 'myntra_store_detailt.product_id','left');
		$products_store = $this->db->get(db_prefix().'myntra_store_detailt')->result_array();
		foreach($products_store as $product){
			$this->db->where('id', $product['id']);
			$this->db->update(db_prefix().'myntra_store_detailt', ['prices' => $product['rate']]);
		}
	...
	/**
	 * Update prices for store products Amazon
	 * @param  $store_id
	 * @param  $arr     
	 * @return boolean       
	 */
	public function amazon_price_update($store_id, $arr = null){
		if($arr != '' && $arr != null){
			$this->db->where(db_prefix().'amazon_store_detailt.product_id IN (' . implode(', ', $arr) . ')');
		}
		$this->db->select('*, '.db_prefix().'amazon_store_detailt.id as id');
		$this->db->where('amazon_store_id', $store_id);
		$this->db->join(db_prefix() . 'items', db_prefix() . 'items.id = '.db_prefix() . 'amazon_store_detailt.product_id','left');
		$products_store = $this->db->get(db_prefix().'amazon_store_detailt')->result_array();
		foreach($products_store as $product){
			$this->db->where('id', $product['id']);
			$this->db->update(db_prefix().'amazon_store_detailt', ['prices' => $product['rate']]);
		}
...
/**
 ...
 /**
	...
	/**
	 * get list product store flipkart
	 * @param string $store_id 
	 * @return array        
	 */
	public function get_list_product_store_flipkart($store_id = ''){
		$this->db->select(db_prefix() . 'ware_unit_type.unit_name'.','.db_prefix() . 'items.*, '.db_prefix().'items_groups.id as group_id, '.db_prefix().'items_groups.name as group_name');
		$this->db->where(db_prefix() . 'flipkart_store_detailt.flipkart_store_id', $store_id);
		$this->db->join(db_prefix() . 'ware_unit_type', db_prefix() . 'ware_unit_type.unit_type_id=' . db_prefix() . 'items.unit_id', 'left');
		$this->db->join(db_prefix() . 'flipkart_store_detailt', db_prefix() . 'flipkart_store_detailt.product_id=' . db_prefix() . 'items.id', 'left');
		$this->db->join(db_prefix() . 'items_groups', db_prefix() . 'items_groups.id = '.db_prefix() . 'items.group_id', 'left');
		return $this->db->get(db_prefix().'items')->result_array();
	}

	/**
	 * get list product store myntra
	 * @param string $store_id 
	 * @return array        
	 */
	public function get_list_product_store_myntra($store_id = ''){
		$this->db->select(db_prefix() . 'ware_unit_type.unit_name'.','.db_prefix() . 'items.*, '.db_prefix().'items_groups.id as group_id, '.db_prefix().'items_groups.name as group_name');
		$this->db->where(db_prefix() . 'myntra_store_detailt.myntra_store_id', $store_id);
		$this->db->join(db_prefix() . 'ware_unit_type', db_prefix() . 'ware_unit_type.unit_type_id=' . db_prefix() . 'items.unit_id', 'left');
		$this->db->join(db_prefix() . 'myntra_store_detailt', db_prefix() . 'myntra_store_detailt.product_id=' . db_prefix() . 'items.id', 'left');
		$this->db->join(db_prefix() . 'items_groups', db_prefix() . 'items_groups.id = '.db_prefix() . 'items.group_id', 'left');
		return $this->db->get(db_prefix().'items')->result_array();
	}

	/**
	 * get list product store amazon
	 * @param string $store_id 
	 * @return array        
	 */
	public function get_list_product_store_amazon($store_id = ''){
		$this->db->select(db_prefix() . 'ware_unit_type.unit_name'.','.db_prefix() . 'items.*, '.db_prefix().'items_groups.id as group_id, '.db_prefix().'items_groups.name as group_name');
		$this->db->where(db_prefix() . 'amazon_store_detailt.amazon_store_id', $store_id);
		$this->db->join(db_prefix() . 'ware_unit_type', db_prefix() . 'ware_unit_type.unit_type_id=' . db_prefix() . 'items.unit_id', 'left');
		$this->db->join(db_prefix() . 'amazon_store_detailt', db_prefix() . 'amazon_store_detailt.product_id=' . db_prefix() . 'items.id', 'left');
		$this->db->join(db_prefix() . 'items_groups', db_prefix() . 'items_groups.id = '.db_prefix() . 'items.group_id', 'left');
		return $this->db->get(db_prefix().'items')->result_array();
	}
