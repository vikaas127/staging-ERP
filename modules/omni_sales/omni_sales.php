...
function omni_sales_add_head_component(){
    ...
    if (!(strpos($viewuri,'/omni_sales/omni_sales_client/sales') === false)) {
        echo '<link href="' . module_dir_url(OMNI_SALES_MODULE_NAME, 'assets/css/omni_sales.css') . '?v='.time().'" rel="stylesheet" type="text/css" />';
    } 
    
    if(!(strpos($viewuri,'/admin/omni_sales/detail_channel_wcm') === false) || !(strpos($viewuri,'/admin/omni_sales/detail_channel_fkt') === false) || !(strpos($viewuri,'/admin/omni_sales/add_woocommerce_store') === false) || !(strpos($viewuri,'/admin/omni_sales/setting') === false) || !(strpos($viewuri,'/admin/omni_sales/detail_channel_myntra') === false) || !(strpos($viewuri,'/admin/omni_sales/detail_channel_amazon') === false) ){
...
function omni_sales_load_js(){
    ...
    }elseif(!(strpos($viewuri,'/admin/omni_sales/add_woocommerce_store') === false) || !(strpos($viewuri,'/admin/omni_sales/add_flipkart_store') === false) || !(strpos($viewuri,'/admin/omni_sales/detail_channel_fkt') === false)  || !(strpos($viewuri,'/admin/omni_sales/detail_channel_wcm') === false) || !(strpos($viewuri,'/admin/omni_sales/setting') === false) || !(strpos($viewuri,'/admin/omni_sales/add_myntra_store') === false) || !(strpos($viewuri,'/admin/omni_sales/detail_channel_myntra') === false) || !(strpos($viewuri,'/admin/omni_sales/detail_channel_amazon') === false) || !(strpos($viewuri,'/admin/omni_sales/add_amazon_store') === false) ){
        echo '<script src="'.module_dir_url(OMNI_SALES_MODULE_NAME, 'assets/js/sales_channel/manage_channel_woocommerce.js').'?v=3.5"></script>';
    }
...
if (!(strpos($viewuri,'/admin/omni_sales/pos') === false)) {
    ...
    echo '<link rel="stylesheet" type="text/css" id="bootstrap-select-css" href="' . site_url() . 'assets/css/style.min.css?v=' . time() . '">';
