										...
										<div class="row">
											...
											<div class="col-md-12">
												...
												<div class="btn-group pull-right">
													<button href="#" class="dropdown-toggle btn" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true" >
														<i class="fa-regular fa-file-pdf"></i><?php if (is_mobile()) { echo ' PDF'; } ?>
														<span class="caret" data-toggle="" data-placement="top" data-original-title="<?php echo ' PDF'; ?>"></span>
													</button>
													<ul class="dropdown-menu animated fadeIn">
														<li class="hidden-xs">
															<a href="<?php echo admin_url('omni_sales/pdf/' . $order->id . '?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a>
														</li>
														<li class="hidden-xs">
															<a href="<?php echo admin_url('omni_sales/pdf/' . $order->id . '?output_type=I'); ?>" target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a>
														</li>
														<li>
															<a href="<?php echo admin_url('omni_sales/pdf/' . $order->id); ?>"><?php echo _l('download'); ?></a>
														</li>
														<li>
															<a href="<?php echo admin_url('omni_sales/pdf/' . $order->id . '?print=true'); ?>" target="_blank"><?php echo _l('print'); ?></a>
														</li>
													</ul>
												</div>
									...
									<tbody>
										...
										<?php if($order->discount){
											...
											<?php if($order->channel == 'manual'){ ?>
												...
												<?php } ?>
												<?php 
													if(isset($order->shipping_value) && $order->shipping_value != "0.00" && get_option('omni_sale_hide_shipping_fee') == 0){ ?>
														<tr>
													...
													else if(isset($order->shipping) && $order->shipping != "0.00"  && get_option('omni_sale_hide_shipping_fee') == 0){ ?>
														<tr>
																<td><span class="bold"><?php echo _l('shipping'); ?> :</span>
																</td>
																<td>
