...
<div class="row dflex">
  ...
  <div class="position-relative pull-right">
    <a href="Javascript:void(0);" id="toggle_popup_crm" class="btn btn-info display-block pull-right"><i class="fa fa-refresh"></i><?php echo 'Sync to amazon' ?><i class="fa fa-caret-down"></i>
    </a>
    <ul id="popup_approval" class="dropdown-menu dropdown-menu-right">
      <li>
        <a href="#" onclick="sync_all_amazon(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_all") ?>" class="btn btn-info display-block"><i class="fa fa fa-refresh  " data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('sync_all'); ?></a>
      </li>
      <li>
        <a href="#" onclick="sync_decriptions_synchronization_amazon(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" class="btn btn-info display-block" data-toggle="tooltip" data-placeme="top" data-original-title="<?php echo _l("sync_decriptions") ?>" ><i class="fa fa-info" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('long_decriptions'); ?>
        </a>
      </li>
      <li>
        <a href="#" onclick="sync_images_synchronization_amazon(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo _l("sync_images") ?>"  class="btn btn-info display-block"><i class="fa fa-picture-o" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('images'); ?></a>
      </li>

      <li>
        <a href="#" onclick="sync_price_amazon(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_price") ?>" class="btn btn-info display-block"><i class="fa fa fa-money" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('sync_price'); ?></a>
      </li>

      <li>
        <a href="#" onclick="sync_inventory_synchronization_amazon(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_from_store") ?>" class="btn btn-info display-block"><i class="fa fa-snowflake-o" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('inventory_sync'); ?></a>
      </li>

      <li>
        <a href="#" onclick="sync_product_name_amazon(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_from_store") ?>" class="btn btn-info display-block"><i class="fa fa-sun-o" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('product_name'); ?></a>
      </li>

      <li>
        <a href="#" onclick="sync_short_description_amazon(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_from_store") ?>" class="btn btn-info display-block"><i class="fa fa-ticket"></i><?php echo ' '._l('short_description'); ?></a>
      </li>
    </ul>
  </div>
  <a href="#" onclick="price_update_amazon(this); return false;" class="btn btn-info pull-right mbot10 mright15 " data-id="<?php echo html_entity_decode($id); ?>"><i class="fa fa-pencil" aria-hidden="true"></i>
...
<div class="modal bulk_actions" id="product-woocommerce_bulk_actions" tabindex="-1" role="dialog">
  ...
  <div class="modal-footer">
   ...
   <?php if(has_permission('warehouse','','delete') || is_admin()){ ?>
     <a href="#" class="btn btn-info" onclick="omi_sales_delete_bulk_action_amazon(this); return false;"><?php echo _l('confirm'); ?></a>
   <?php } ?>
 </div>
</div>
