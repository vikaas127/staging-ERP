...
<div class="row dflex">
  <div class="col-sm-4 pright0">
    <a href="#" onclick="add_product_flipkart(); return false;" class="btn btn-info pull-left mbot10">
      <?php echo _l('add'); ?>
    </a>
  ...
  <div class="col-sm-8">
    ...
    <div class="position-relative pull-right">
      ...
      <ul id="popup_woo" class="dropdown-menu dropdown-menu-right position-absolute">
        <li>
          <a href="#" onclick="sync_store_flipkart(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" class="btn btn-success pull-right display-block orders-woo" data-toggle="tooltip" data-placeme="top" data-original-title="<?php echo _l("sync_from_the_system_to_the_store") ?>"><i class="fa fa-first-order" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('omni_order'); ?>
        </a>
      </li>
      <li>
        <a href="#" data-id="<?php echo html_entity_decode($id); ?>" class="btn btn-success pull-right display-block sync_products_from_fkt" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo _l("sync_products_from_store") ?>"><i class="fa fa-forward"></i><?php echo ' '._l('product'); ?></a>
      </li>
    </ul>
  </div>
  ...
  <div class="position-relative pull-right">
    <a href="Javascript:void(0);" id="toggle_popup_crm" class="btn btn-info display-block pull-right"><i class="fa fa-refresh"></i><?php echo 'Sync to Flipkart'; ?><i class="fa fa-caret-down"></i>
    </a>
    <ul id="popup_approval" class="dropdown-menu dropdown-menu-right">
      <li>
        <a href="#" onclick="sync_all_fkt(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_all") ?>" class="btn btn-info display-block"><i class="fa fa fa-refresh  " data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('sync_all'); ?></a>
      </li>
      <li>
        <a href="#" onclick="sync_decriptions_synchronization_fkt(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" class="btn btn-info display-block" data-toggle="tooltip" data-placeme="top" data-original-title="<?php echo _l("sync_decriptions") ?>" ><i class="fa fa-info" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('long_decriptions'); ?>
        </a>
      </li>
      <li>
        <a href="#" onclick="sync_images_synchronization_fkt(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo _l("sync_images") ?>"  class="btn btn-info display-block"><i class="fa fa-picture-o" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('images'); ?></a>
      </li>

      <li>
        <a href="#" onclick="sync_price_fkt(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_price") ?>" class="btn btn-info display-block"><i class="fa fa fa-money" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('sync_price'); ?></a>
      </li>

      <li>
        <a href="#" onclick="sync_inventory_synchronization_fkt(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_from_store") ?>" class="btn btn-info display-block"><i class="fa fa-snowflake-o" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('inventory_sync'); ?></a>
      </li>

      <li>
        <a href="#" onclick="sync_product_name_fkt(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_from_store") ?>" class="btn btn-info display-block"><i class="fa fa-sun-o" data-toggle="dropdown" aria-expanded="false"></i><?php echo ' '._l('product_name'); ?></a>
      </li>

      <li>
        <a href="#" onclick="sync_short_description_fkt(this); return false;" data-id="<?php echo html_entity_decode($id); ?>" data-toggle="tooltip" data-original-title="<?php echo _l("sync_from_store") ?>" class="btn btn-info display-block"><i class="fa fa-ticket"></i><?php echo ' '._l('short_description'); ?></a>
      </li>
    </ul>
  </div>
  <a href="#" onclick="price_update_fkt(this); return false;" class="btn btn-info pull-right mbot10 mright15 " data-id="<?php echo html_entity_decode($id); ?>"><i class="fa fa-pencil" aria-hidden="true"></i>
...
render_datatable($table_data,'product-flipkart',
  array('customizable-table'),
  array(
    'proposal_sm' => 'proposal_sm',
    'id'=>'table-product-flipkart',
  ...
  <div class="modal fade" id="chose_product" tabindex="-1" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <?php echo form_open(admin_url('omni_sales/add_product_channel_fkt'),array('id'=>'form_add_product')); ?>             
        <div class="modal-body">
         <div class="row">
          <input type="hidden" name="flipkart_store_id" value="<?php echo html_entity_decode($id); ?>">
          <div class="col-md-12">
            <?php 
