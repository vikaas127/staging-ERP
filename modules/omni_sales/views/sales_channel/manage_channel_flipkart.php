   ...
   <div class="panel_s">
    <div class="panel-body">
	 ...
	 <div class="col-md-12">
	     ...
	     <div class="col-md-3"> 
		    <a href="#" id="add_channel_flipkart" class="btn btn-info pull-left">
		        <?php echo _l('add'); ?>
		    </a>
		    <div class="clearfix"></div><br>
		 </div>
		...
		<?php
	        ...
	        render_datatable($table_data,'channel-flipkart');
      	?>
	</div>
  </div>
 </div>
</div>
<div class="modal fade" id="channel_flipkart" tabindex="-1" role="dialog">
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">
                <span class="add-title"><?php echo _l('add_channel_flipkart'); ?></span>
                <span class="update-title hide"><?php echo _l('edit_channel_flipkart'); ?></span>
            </h4>
        </div>
    <?php echo form_open(admin_url('omni_sales/add_channel_flipkart'),array('id'=>'form_add_channel_flipkart')); ?>	            
