                    ...
                    <div class="panel-body">
                      <div class="horizontal-scrollable-tabs mb-5">
                        ...
                        <div class="horizontal-tabs mb-4">
                          <ul class="nav nav-tabs nav-tabs-horizontal">
                            <?php
                              ...
                              foreach($tab as $group){
                                ...
                                <a href="<?php echo admin_url('omni_sales/detail_channel_amazon/'.$id.'?group='.$group); ?>" data-group="<?php echo html_entity_decode($group); ?>">
                                  <?php 
                                  if($group == 'product'){
                                    echo _l('os_product'); 
                                  }else{
                          ...
                          <a href="<?php echo admin_url('omni_sales/detail_channel_order_amazon/'.$id); ?>" class="btn btn-info pull-right mbot10 mright15  waves-effect waves-effect waves-light waves-ripple" data-id="3">
                            Check Orders
                          </a>
                          <?php if($status == 0 ){ ?>
