						...
						<div role="tabpanel" class="tab-pane active" id="omni_setting_product">
							<div class="row">
								...
								<div class="col-md-3">
									<?php 
									$customer_data = [];
									foreach($omni_customer as $value){
										if($value['userid'] != null && $value['company'] != null){
											$customer_data[] = ['userid' => $value['userid'], 'company' => $value['company']];
										}
									}
									echo render_select('customer_filter[]', $customer_data, array('userid', 'company'), 'omni_customer','', array('multiple' => true, 'data-actions-box' => true), [], '', '', false); ?>
								</div>							
							</div>	
							<div class="row">
								<div class="col-md-12">
