...
class Omni_sales extends AdminController
{
		...
		/**
		 * delete product flipkart
		 * @param  int $channel 
		 * @param  int $id      
		 * @return redirect
		 */
		public function delete_product_flipkart($channel,$id){
			$response = $this->omni_sales_model->delete_product_flipkart($id);
			if($response == true){
				set_alert('success', _l('deleted', _l('category')));
			}
			else{
		...
		/**
		 * delete product amazon
		 * @param  int $channel 
		 * @param  int $id      
		 * @return redirect
		 */
		public function delete_product_amazon($channel,$id){
			$response = $this->omni_sales_model->delete_product_amazon($id);
			if($response == true){
				set_alert('success', _l('deleted', _l('category')));
			}
			else{
		 ...
		 * @return redirect
		 */
		public function delete_product_myntra($channel,$id){
			$response = $this->omni_sales_model->delete_product_myntra($id);
			if($response == true){
				set_alert('success', _l('deleted', _l('category')));
			}
			else{
		 ...
		 * @return view
		 */
		public function add_flipkart_store(){
			$data['title'] = _l('channel_Flipkart');
			$this->load->view('sales_channel/manage_channel_flipkart', $data);
		}
		 ...
		 * @return view
		 */
		public function add_amazon_store(){
			$data['title'] = _l('channel_Amazon');
			$this->load->view('sales_channel/manage_channel_amazon', $data);
		}
		 ...
		 * @return view
		 */
		public function add_myntra_store(){
			$data['title'] = _l('channel_Myntra');
			$this->load->view('sales_channel/manage_channel_myntra', $data);
		}
		 ...
		 * @return redirect
		 */
		public function add_channel_flipkart(){
			if($this->input->post()){
				$data = $this->input->post();
				if($data['id'] == ''){
					$insert_id = $this->omni_sales_model->add_channel_flipkart($data);
					if ($insert_id) {
						$message = _l('added_successfully');
						set_alert('success', $message);
					}
					...
					$id = $data['id'];
					unset($data['id']);
					$success = $this->omni_sales_model->update_channel_flipkart($data, $id);
					if ($success) {
						$message = _l('updated_successfully');
						set_alert('success', $message);
					}
				}
				redirect(admin_url('omni_sales/add_flipkart_store/'));
			}
		}
		 ...
		 * @return redirect
		 */
		public function add_channel_amazon(){
			if($this->input->post()){
				$data = $this->input->post();
				if($data['id'] == ''){
					$insert_id = $this->omni_sales_model->add_channel_amazon($data);
					if ($insert_id) {
						$message = _l('added_successfully');
						set_alert('success', $message);
					}
					...
					$id = $data['id'];
					unset($data['id']);
					$success = $this->omni_sales_model->update_channel_amazon($data, $id);
					if ($success) {
						$message = _l('updated_successfully');
						set_alert('success', $message);
					}
				}
				redirect(admin_url('omni_sales/add_amazon_store/'));
			}
		}
		 ...
		 * @return redirect
		 */
		public function add_channel_myntra(){
			if($this->input->post()){
				$data = $this->input->post();
				if($data['id'] == ''){
					$insert_id = $this->omni_sales_model->add_channel_myntra($data);
					if ($insert_id) {
						$message = _l('added_successfully');
						set_alert('success', $message);
					}
					...
					$id = $data['id'];
					unset($data['id']);
					$success = $this->omni_sales_model->update_channel_myntra($data, $id);
					if ($success) {
						$message = _l('updated_successfully');
						set_alert('success', $message);
					}
				}
				redirect(admin_url('omni_sales/add_myntra_store/'));
			}
		}
		...
		/**
		 * table channel flipkart
		 * @return table
		 */
		public function table_channel_flipkart(){
			$this->app->get_table_data(module_views_path('omni_sales', 'table/table_channel_flipkart'));
		}

		/**
		 * table channel amazon
		 * @return table
		 */
		public function table_channel_amazon(){
			$this->app->get_table_data(module_views_path('omni_sales', 'table/table_channel_amazon'));
		}

		/**
		 * table channel myntra
		 * @return table
		 */
		public function table_channel_myntra(){
			$this->app->get_table_data(module_views_path('omni_sales', 'table/table_channel_myntra'));
		}
		 ...
		 * @return view
		 */
		public function detail_channel_fkt($id){
			$data['group'] = $this->input->get('group');

			$data['title'] = _l('detail_channel_fkt');

			$data['tab'][] = 'product_flipkart';

			if($data['group'] == ''){
				$data['group'] = 'product_flipkart';
			}

			$data['tabs']['view'] = 'includes/'.$data['group'];
			$data['id'] = $id;
			$data['group_product'] = $this->omni_sales_model->get_group_product();
			$store_choose = $this->omni_sales_model->get_ids_flipkart_store_detailt($id);
			$data['omni_warehouse'] = $this->omni_sales_model->omnisales_get_warehouse();
			$data['products'] = [];
			$products = $this->omni_sales_model->get_product_parent_id();
			if(count($products) > 0){
			...
			$data['status'] = get_option('status_sync');
			$this->load->view('sales_channel/detail_channel_flipkart', $data);
		}

		/**
		 * detail channel amazon 
		 * @param  int $id
		 * @return view
		 */
		public function detail_channel_amazon($id){
			$data['group'] = $this->input->get('group');

			$data['title'] = _l('detail_channel_amazon');

			$data['tab'][] = 'product_amazon';

			if($data['group'] == ''){
				$data['group'] = 'product_amazon';
			}

			$data['tabs']['view'] = 'includes/'.$data['group'];
			$data['id'] = $id;
			$data['group_product'] = $this->omni_sales_model->get_group_product();
			$store_choose = $this->omni_sales_model->get_ids_amazon_store_detailt($id);
			$data['omni_warehouse'] = $this->omni_sales_model->omnisales_get_warehouse();
			$data['products'] = [];
			$products = $this->omni_sales_model->get_product_parent_id();
			if(count($products) > 0){
			...
			$data['status'] = get_option('status_sync');
			$this->load->view('sales_channel/detail_channel_amazon', $data);
		}

		/**
		 * detail channel myntra 
		 * @param  int $id
		 * @return view
		 */
		public function detail_channel_myntra($id){
			$data['group'] = $this->input->get('group');

			$data['title'] = _l('detail_channel_myntra');

			$data['tab'][] = 'product_myntra';

			if($data['group'] == ''){
				$data['group'] = 'product_myntra';
			}

			$data['tabs']['view'] = 'includes/'.$data['group'];
			$data['id'] = $id;
			$data['group_product'] = $this->omni_sales_model->get_group_product();
			$store_choose = $this->omni_sales_model->get_ids_myntra_store_detailt($id);
			$data['omni_warehouse'] = $this->omni_sales_model->omnisales_get_warehouse();
			$data['products'] = [];
			$products = $this->omni_sales_model->get_product_parent_id();
			if(count($products) > 0){
			...
			$data['status'] = get_option('status_sync');
			$this->load->view('sales_channel/detail_channel_myntra', $data);
		}
		 ...
		 * @return view
		 */
		public function detail_channel_order_amazon($id){
			$data['group'] = $this->input->get('group');

			$data['title'] = _l('detail_channel_order_amazon');

			$data['tab'][] = 'order_amazaon';

			if($data['group'] == ''){
				$data['group'] = 'order_amazon';
			}

			$data['tabs']['view'] = 'includes/'.$data['group'];
			$data['id'] = $id;
			$data['group_product'] = $this->omni_sales_model->get_group_orders();
			$store_choose = $this->omni_sales_model->get_ids_amazon_store_detailt($id);
			$data['omni_warehouse'] = $this->omni_sales_model->omnisales_get_warehouse();
			$data['products'] = [];
			$products = $this->omni_sales_model->get_product_parent_id();
			...
			$data['status'] = get_option('status_sync');
			$this->load->view('sales_channel/detail_channel_order_amazon', $data);
		}
		 ...
		 * @return view
		 */
		public function detail_channel_order_myntra($id){
			$data['group'] = $this->input->get('group');

			$data['title'] = _l('detail_channel_order_myntra');

			$data['tab'][] = 'order_myntra';

			if($data['group'] == ''){
				$data['group'] = 'order_myntra';
			}
			...
			$data['status'] = get_option('status_sync');
			$this->load->view('sales_channel/detail_channel_order_myntra', $data);
		}
		 ...
		 * @return  redirect
		 */
		public function delete_channel_fkt($id){
			$response = $this->omni_sales_model->delete_channel_flipkart($id);
			if($response == true){
				set_alert('success', _l('deleted'));
			}
			else{
		...
		public function delete_channel_amazon($id){
			$response = $this->omni_sales_model->delete_channel_amazon($id);
			if($response == true){
				set_alert('success', _l('deleted'));
			}
			else{
		...
		public function delete_channel_myntra($id){
			$response = $this->omni_sales_model->delete_channel_myntra($id);
			if($response == true){
				set_alert('success', _l('deleted'));
			}
			else{
		...
		/**
		 * table product flipkart
		 * @return table
		 */
		public function table_product_flipkart(){
			$this->app->get_table_data(module_views_path('omni_sales', 'table/table_product_flipkart'));
		}

		/**
		 * table product myntra
		 * @return table
		 */
		public function table_product_myntra(){
			$this->app->get_table_data(module_views_path('omni_sales', 'table/table_product_myntra'));
		}
		 ...
		 * @return table
		 */
		public function table_product_amazon(){
			$this->app->get_table_data(module_views_path('omni_sales', 'table/table_product_amazon'));
		}
		 ...
		 * @return redirect
		 */
		public function add_product_channel_fkt(){
			if($this->input->post()){
				$data = $this->input->post();
				if($data['flipkart_store_id'] != ''){
					$channel = $data['flipkart_store_id'];
					$insert_id = $this->omni_sales_model->add_product_channel_fkt($data);
					if ($insert_id) {
						$message = _l('added_successfully');
						set_alert('success', $message);
					}
					redirect(admin_url('omni_sales/detail_channel_fkt/'.$data['flipkart_store_id'].'?group=product_flipkart'));
				}           
			}
		}
		 ...
		 * @return redirect
		 */
		public function add_product_channel_myntra(){
			if($this->input->post()){
				$data = $this->input->post();
				if($data['myntra_store_id'] != ''){
					$channel = $data['myntra_store_id'];
					$insert_id = $this->omni_sales_model->add_product_channel_myntra($data);
					if ($insert_id) {
						$message = _l('added_successfully');
						set_alert('success', $message);
					}
					redirect(admin_url('omni_sales/detail_channel_myntra/'.$data['myntra_store_id'].'?group=product_myntra'));
				}           
			}
		}
		 ...
		 * @return redirect
		 */
		public function add_product_channel_amazon(){
			if($this->input->post()){
				$data = $this->input->post();
				if($data['amazon_store_id'] != ''){
					$channel = $data['amazon_store_id'];
					$insert_id = $this->omni_sales_model->add_product_channel_amazon($data);
					if ($insert_id) {
						$message = _l('added_successfully');
						set_alert('success', $message);
					}
					redirect(admin_url('omni_sales/detail_channel_amazon/'.$data['amazon_store_id'].'?group=product_amazon'));
				}           
			}
		}
		...
		public function process_orders_flipkart($store_id){
			update_option('status_sync', 1);
			$result = $this->omni_sales_model->process_orders_flipkart($store_id);
			update_option('status_sync', 2);
			echo json_encode($result);
		}
		...
		public function process_orders_myntra($store_id){
			update_option('status_sync', 1);
			$result = $this->omni_sales_model->process_orders_myntra($store_id);
			update_option('status_sync', 2);
			echo json_encode($result);
		}
		...
		public function process_orders_amazon($store_id){
			update_option('status_sync', 1);
			$result = $this->omni_sales_model->process_orders_amazon($store_id);
			update_option('status_sync', 2);
			echo json_encode($result);
		}
	...
	public function get_store_woo(){
		...
		public function delete_product_store_flipkart($store ,$id){
			$response = $this->omni_sales_model->delete_product_store_flipkart($store, $id);
			if($response == true){
				set_alert('success', _l('deleted', _l('product_store')));
			}
			else{
			...
			redirect(admin_url('omni_sales/detail_channel_fkt/'.$store));
		}

		/**
		 * { delete product store amazon }
		 *
		 * @param  $store  The store
		 * @param  $id     The identifier
		 * @return redirect
		...
		public function delete_product_store_amazon($store ,$id){
			$response = $this->omni_sales_model->delete_product_store_amazon($store, $id);
			if($response == true){
				set_alert('success', _l('deleted', _l('product_store')));
			}
			else{
			...
			redirect(admin_url('omni_sales/detail_channel_amazon/'.$store));
		}

		/**
		 * { delete product store myntra}
		 *
		 * @param  $store  The store
		 * @param  $id     The identifier
		 * @return redirect
		...
		public function delete_product_store_myntra($store ,$id){
			$response = $this->omni_sales_model->delete_product_store_myntra($store, $id);
			if($response == true){
				set_alert('success', _l('deleted', _l('product_store')));
			}
			else{
			...
			redirect(admin_url('omni_sales/detail_channel_myntra/'.$store));
		}
		 ...
		 * @return json
		 */
		public function test_connect_flipkart()
		{
			$data = $this->input->post();
			if($data['url'] != '' && $data['consumer_key'] != '' && $data['consumer_secret'] != ''){
				$success = $this->omni_sales_model->test_connect($data);
		 ...
		 * @return json
		 */
		public function test_connect_myntra()
		{
			$data = $this->input->post();
			if($data['url'] != '' && $data['consumer_key'] != '' && $data['consumer_secret'] != '' && $data['refresh_token'] != ''){
				$success = $this->omni_sales_model->test_connect_myntra($data);
				if($success){
					$message = _l('connection_successful');         
				}else{
					$message = _l('connection_failed');         
		 ...
		 * @return json
		 */
		public function test_connect_amazon()
		{
			$data = $this->input->post();
			if($data['url'] != '' && $data['consumer_key'] != '' && $data['consumer_secret'] != '' && $data['refresh_token'] != ''){
				$success = $this->omni_sales_model->test_connect_amamzon($data);
				if($success){
					$message = _l('connection_successful');         
				}else{
					$message = _l('connection_failed');         
		...
		/**
		 *  process asynclibrary inventory flipkart
		 * @param  int $store_id 
		 * @return json
		 */
		public function process_asynclibrary_inventory_detail_flipkart(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->process_inventory_synchronization_detail_flipkart($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}

		/**
		 *  process asynclibrary inventory myntra
		 * @param  int $store_id 
		 * @return json
		 */
		public function process_asynclibrary_inventory_detail_myntra(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->process_inventory_synchronization_detail_myntra($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}

		/**
		 *  process asynclibrary inventory amazon
		 * @param  int $store_id 
		 * @return json
		 */
		public function process_asynclibrary_inventory_detail_amazon(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->process_inventory_synchronization_detail_amazon($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}
		...
		/**
		 *  process asynclibrary image flipkart
		 * @param  int $store_id 
		 * @return json
		 */
		public function process_asynclibrary_image_detail_flipkart(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->process_images_synchronization_detail_flipkart($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}

		/**
		 *  process asynclibrary image myntra
		 * @param  int $store_id 
		 * @return json
		 */
		public function process_asynclibrary_image_detail_myntra(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->process_images_synchronization_detail_myntra($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}

		/**
		 *  process asynclibrary image amamzon
		 * @param  int $store_id 
		 * @return json
		 */
		public function process_asynclibrary_image_detail_amazon(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->process_images_synchronization_detail_amazon($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}
		 ...
		 * @return json
		 */
		public function process_decriptions_synchronization_detail_flipkart(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$result = $this->omni_sales_model->process_decriptions_synchronization_detail_flipkart($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($result);
		}
		 ...
		 * @return json
		 */
		public function process_decriptions_synchronization_detail_myntra(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$result = $this->omni_sales_model->process_decriptions_synchronization_detail_myntra($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($result);
		}
		...
		public function omi_sales_delete_bulk_action_flipkart()
		{
			if (!is_staff_member()) {
				ajax_access_denied();
			}
				...
				if ($this->input->post('mass_delete')) {
					if (is_array($arr_id)) {
						foreach ($arr_id as $id) {
							switch ($rel_type) {
								case 'omni_sales':
								if ($this->omni_sales_model->delete_product_store_all_flipkart($store, $id)) {
									$total_deleted++;
									break;
								}else{
									break;
		...
		public function omi_sales_delete_bulk_action_myntra()
		{
			if (!is_staff_member()) {
				ajax_access_denied();
			}
				...
				if ($this->input->post('mass_delete')) {
					if (is_array($arr_id)) {
						foreach ($arr_id as $id) {
							switch ($rel_type) {
								case 'omni_sales':
								if ($this->omni_sales_model->delete_product_store_all_myntra($store, $id)) {
									$total_deleted++;
									break;
								}else{
									break;
		...
		public function omi_sales_delete_bulk_action_amazon()
		{
			if (!is_staff_member()) {
				ajax_access_denied();
			}
				...
				if ($this->input->post('mass_delete')) {
					if (is_array($arr_id)) {
						foreach ($arr_id as $id) {
							switch ($rel_type) {
								case 'omni_sales':
								if ($this->omni_sales_model->delete_product_store_all_amazon($store, $id)) {
									$total_deleted++;
									break;
								}else{
									break;
		...
		/**
		 *  Sync price store flipkart
		 * @return json
		 */
		public function sync_price_flipkart(){
			$data = $this->input->post();
			$detail = isset($data["arr_val"]) ? $data["arr_val"] : null;
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->process_price_synchronization_flipkart($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}

		/**
		 *  Sync price store myntra
		 * @return json
		 */
		public function sync_price_myntra(){
			$data = $this->input->post();
			$detail = isset($data["arr_val"]) ? $data["arr_val"] : null;
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->process_price_synchronization_myntra($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}

		/**
		 *  Sync price store amazon
		 * @return json
		 */
		public function sync_price_amazon(){
			$data = $this->input->post();
			$detail = isset($data["arr_val"]) ? $data["arr_val"] : null;
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->process_price_synchronization_amazon($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}
		...
		/**
		 * sync all info products to store Flipkart
		 * @return json
		 */
		public function sync_all_flipkart(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->sync_all_flipkart($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}

		/**
		 * sync all info products to store Myntra
		 * @return json
		 */
		public function sync_all_myntra(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->sync_all_myntra($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}

		/**
		 * sync all info products to store Amazon
		 * @return json
		 */
		public function sync_all_amazon(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->sync_all_amazon($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}
 ...
 /**
	...
	*/
	 ...
	 * @return json
	 */
	public function sync_product_name_flipkart(){
		$data = $this->input->post();
		$detail = $data["arr_val"];
		$store_id = $data["id"];
		update_option('status_sync', 1);
		$success = $this->omni_sales_model->sync_product_name_flipkart($store_id, $detail);
		update_option('status_sync', 2);
		echo json_encode($success);
	}
	...
	public function sync_product_name_all($store_id){
		 ...
		 * @return json
		 */
		public function sync_short_description_flipkart(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->sync_short_description_flipkart($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}
		 ...
		 * @return json
		 */
		public function sync_short_description_myntra(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->sync_short_description_myntra($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}
		 ...
		 * @return json
		 */
		public function sync_short_description_amazon(){
			$data = $this->input->post();
			$detail = $data["arr_val"];
			$store_id = $data["id"];
			update_option('status_sync', 1);
			$success = $this->omni_sales_model->sync_short_description_amazon($store_id, $detail);
			update_option('status_sync', 2);
			echo json_encode($success);
		}
...
public function create_purchase_request(){
	 ...
	 * @return json
	 */
	public function fkt_price_update($store_id = ''){
		$data = $this->input->post();
		$detail = isset($data["arr_val"]) ? $data["arr_val"] : null;
		if(isset($data['id'])){
			$store_id = $data["id"];
		}
		$success = $this->omni_sales_model->fkt_price_update($store_id, $detail);
		echo json_encode($success);
	}
	 ...
	 * @return json
	 */
	public function myntra_price_update($store_id = ''){
		$data = $this->input->post();
		$detail = isset($data["arr_val"]) ? $data["arr_val"] : null;
		if(isset($data['id'])){
			$store_id = $data["id"];
		}
		$success = $this->omni_sales_model->myntra_price_update($store_id, $detail);
		echo json_encode($success);
	}
	 ...
	 * @return json
	 */
	public function amazon_price_update($store_id = ''){
		$data = $this->input->post();
		$detail = isset($data["arr_val"]) ? $data["arr_val"] : null;
		if(isset($data['id'])){
			$store_id = $data["id"];
		}
		$success = $this->omni_sales_model->amazon_price_update($store_id, $detail);
		echo json_encode($success);
	}
