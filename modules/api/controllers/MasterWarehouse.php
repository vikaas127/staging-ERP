 ...
 */
class MasterWarehouse extends REST_Controller {
    ...
    public function data_get($id = '') {
        ...
        $data = $this->Api_model->get_table('masterwarehouse', $id);

if ($data) {
    // Full static mapping of country codes to country names
    ...
    public function data_search_get($key = '') {
        // If the id parameter doesn't exist return all the
        $data = $this->Api_model->search('options', $key);
