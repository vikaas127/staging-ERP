...
class Customers extends REST_Controller {
    ...
    // Add country_name to the response
        ...
        // Loop through each company and add country names
    foreach ($data as $key => $company) {
        $data[$key]['country_name'] = isset($country_mapping[$company['country']]) ? $country_mapping[$company['country']] : 'India';
        $data[$key]['billing_country_name'] = isset($country_mapping[$company['billing_country']]) ? $country_mapping[$company['billing_country']] : 'India';
        $data[$key]['shipping_country_name'] = isset($country_mapping[$company['shipping_country']]) ? $country_mapping[$company['shipping_country']] : 'India';
    }
    ...
    /*public function data_get($id='') {
       $data = $this->Api_model->get_table('companyinfo', $id);
        if ($data) {
