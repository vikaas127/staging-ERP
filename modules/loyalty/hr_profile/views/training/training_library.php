			...
			<?php if(has_permission('staffmanage_training','','create') || has_permission('staffmanage_training','','view')){ ?>
				<div class="_buttons">
					<?php if(has_permission('staffmanage_training','','create')){ ?>
						<a href="<?php echo admin_url('hr_profile/position_training'); ?>" class="btn btn-primary pull-left display-block" >
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<?php if(has_permission('staffmanage_training','','delete') || is_admin()){ ?>
								<a href="#" class="btn btn-primary" onclick="training_library_delete_bulk_action(this); return false;"><?php echo _l('hr_confirm'); ?></a>
							<?php } ?>
						</div>
					</div>
				</div>
