    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo new_html_entity_decode(isset($contract) ? $contract->contract_code : ''); ?></h4>
            </div>
                      ...
                      <table class="table border table-striped ">
                        <tbody>
                            <tr class="project-overview">
                              ...
                              <td><?php echo new_html_entity_decode($contract->contract_code); ?></td>
                            </tr>
                             <tr class="project-overview">
