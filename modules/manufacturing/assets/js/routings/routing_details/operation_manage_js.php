...
<script>
	...
	var operation_table_view = $('.table-operation_table_view');
	initDataTable(operation_table_view, admin_url+'manufacturing/operation_table_view',[0],[0], InvoiceServerParams, [1 ,'asc']);
