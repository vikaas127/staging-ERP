			...
			<div class="col-md-12">
				<div class="panel_s"> 
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12">
								<h4 class="h4-color no-margin"><i class="fa fa-address-card" aria-hidden="true"></i> <?php echo _l('sub_contract'); ?></h4>
							</div>
						</div>
						<hr class="hr-color">
...
<?php init_tail(); ?>
<?php 
require('modules/manufacturing/assets/js/sub_contract/sub_contract_manage_js.php');
?>
</body>
</html>
