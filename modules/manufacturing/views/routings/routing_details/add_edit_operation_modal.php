			...
			<div class="modal-header">
				...
				if(isset($operation)){
					...
					$operation_value = $operation->operation;
					 $subcontracter_id=$operation->subcontractor_id;
					...
					<div class="row">
						...
						<div class="row">
							<div class=col-md-12>
								...
								<div class="col-md-6" id="vendor_display_section" style="display:none;">
 
    
    <div class="col-md-6">
											<?php echo render_select('subcontractor_display', $vendors, array('id', 'company'), 'Subcontractor', $subcontracter_id, [], [], '', '', false); ?>
								</div>
