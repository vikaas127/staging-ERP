					...
					foreach($tab as $gr){
						...
						<a href="<?php echo admin_url('manufacturing/setting?group='.$gr); ?>" data-group="<?php echo new_html_entity_decode($gr); ?>">
							<?php
								...
								$icon['mf_permissions'] = '<span class="fa fa-bars menu-icon"></span>';
...
}elseif(!(strpos($viewuri,'admin/manufacturing/setting?group=mf_permission') === false)){
  require('modules/manufacturing/assets/js/settings/mf_permissions_js.php');}
