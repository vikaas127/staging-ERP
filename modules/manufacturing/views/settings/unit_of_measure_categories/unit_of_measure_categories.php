...
<div> 
	...
	<?php if(has_permission('manufacturing', '', 'create')&&has_permission('mrp_settings','','create')){ ?>
		...
		<tbody>
			<?php foreach($categories as $categorie){ ?>
				...
				<tr>
					...
					<td>
						<?php if (has_permission('manufacturing', '', 'edit')&&has_permission('mrp_settings','','delete') || is_admin()) { ?>
						...
						<?php if (has_permission('manufacturing', '', 'delete')&&has_permission('mrp_settings','','delete') || is_admin()) { ?> 
