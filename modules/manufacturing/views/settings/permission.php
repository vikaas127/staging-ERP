<div class="modal fade" id="appointmentMfModal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				$staffid = '';
				if(isset($member)){
					$title .= _l('mf_update_permissions');
					$staffid    = $member->staffid;
				}else{
					$title .= _l('mf_add_permissions');
				}
				?>
				<h4 class="modal-title"><?php echo new_html_entity_decode($title); ?></h4>
			</div>
			<?php echo form_open(admin_url('manufacturing/manufacturing_update_permissions/'.$staffid), array('id' => 'update_permissions')); ?>
				...
				<div class="table-responsive">
					...
					<table class="table table-bordered roles no-margin">
						...
						<tbody>
							...
							$warehouse_permissions = list_manufacturing_permisstion();
...
<?php require('modules/manufacturing/assets/js/settings/permissions_js.php'); ?>