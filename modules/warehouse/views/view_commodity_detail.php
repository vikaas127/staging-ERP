                        ...
                        <div class="row " style="margin-bottom: 15px;">
                           ...
                           <div class="col-md-3">
                              ...
                              <div class="card text-center">
                                      <h6  class="card-heading">Total Inventory </h6>
                                      <h5 class="card-value" id="total-inventory-card">Loading...</h5>
                              </div>
                          </div>

                        <div class="col-md-3">
                          <div class="card text-center">
                              <h6 class="card-heading">Total Value</h6>
                              <h5 class="card-value" id="total-rate-card">0</h5>
                          </div>
                        </div>



                        <?php if (isset($commodity_item)) { ?>
                            <div class="col-md-3">
                              <div class="card text-center">
                                <h6  class="card-heading">Item Code</h6>
                                <h5 class="card-value"><?php echo htmlspecialchars($commodity_item->commodity_code); ?></h5>
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="card text-center">
                                <h6 class="card-heading">Item Group</h6>
                                <h5 class="card-value"><?php echo get_wh_group_name(new_html_entity_decode($commodity_item->group_id))->name ?></h5>
                              </div>
                            </div>
                        <?php } ?>
...
<div class="col-md-6 panel-padding">
    ...
    <div style="margin-left: 30px;">
      ...
      <div class="col-md-1" style="padding-left:0;padding-right:0;"> 
          ...
          <div class="gallery ">
                <div class="wrapper-masonry">
                    <div id="masonry" class="masonry-layout columns-1" style="padding:0">
                        <?php if(isset($commodity_file) && count($commodity_file) > 0){ ?>
                            <?php $first = true;  ?>
                            <?php foreach ($commodity_file as $key => $value) { ?>
                                <?php
          ...
          <button class="next-btn pn-btn ">&#10095;</button>
                            ...
                            <div class="col-md-12">
                            <h2 class="text-center id-h2">Item Details</h2>
                            <hr class="hr-color" >

                              <ul class="detail-tab">
                                <li><button class="tab-link active" data-tab="attr">Attributes</button></li>
                                <li><button class="tab-link" data-tab="description">Description</button></li>

                                <li><button class="tab-link" data-tab="inventory">Inventory</button></li>
                                <li><button class="tab-link" data-tab="pricing">Pricing</button></li>
                                <li><button class="tab-link" data-tab="sales">Sales</button></li>
                                <li><button class="tab-link" data-tab="purchase">Purchase </button></li>
                                <li><button class="tab-link" data-tab="manufacturing">Manufacturig</button></li>


                              </ul>

                              <div id="attr" class="detail-content active">
                                <h3>Classification & Attributes</h3>
                                <p>Item name, code, category, brand, description, and image.</p>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="col-md-6 panel-padding" >
                                      <table class="table border table-striped table-margintop" >
                              ...
                              <div id="description" class="detail-content">
                              <h3>Product Description</h3>
                              <p>Detailed information about the product including its features, specifications, use cases, and any relevant compliance or safety information.</p>
                              ...
                              <div id="inventory" class="detail-content">
                                <h3>Inventory</h3>
                                <p>Current stock, reorder level, warehouse location, serial numbers.</p>
                                <div >
                              ...
                              <div id="pricing" class="detail-content">
                                <h3>Pricing</h3>
                                <p>Purchase price, selling price, standard cost, discounts.</p>
                                <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <div class="card text-center">
                                            <h6  class="card-heading"><?php echo _l('rate'); ?> </h6>
                                            <h5 class="card-value"><?php echo app_format_money((float)$commodity_item->rate,'') ; ?></h5>
                                    </div>
                                  </div>

                                  <div class="col-md-4">
                                    <div class="card text-center">
                                        <h6 class="card-heading"><?php echo _l('_profit_rate_p'); ?></</h6>
                                        <h5 class="card-value" ><?php echo number_format((float)$commodity_item->profif_ratio, 2).'%'; ?></h5>
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="card text-center">
                                        <h6 class="card-heading"><?php echo _l('purchase_price'); ?></</h6>
                                        <h5 class="card-value" ><?php echo app_format_money((float)$commodity_item->purchase_price,'') ; ?></h5>
                                    </div>
                                  </div>
...
<!-- 
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="tab-content col-md-12">
                                  ...
                                  <!-- <div role="tabpanel" class="tab-pane row" id="out_of_stock">
                                      <?php render_datatable(array(
                                        _l('id'),
                                        _l('commodity_name'),
                                        _l('expiry_date'),
                                  ...
                                  <div role="tabpanel" class="tab-pane active row" id="history">
                                      <?php render_datatable(array(
                                    _l('id'),
                                    _l('form_code'),
                                    _l('commodity_code'),
