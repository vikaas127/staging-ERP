<script>
 $(function(){
  'use strict';
    appValidateForm($('#inspection-form'), {
      name: 'required',
    });
});
  ...
  function add_inspection_question(type, training_id) {
      ...
      $.post(admin_url + 'fleet/add_inspection_question_form', data).done(function(response) {
        ...
        if (type == 'textarea') {
            ...
            question_area += '<input type="' + type + '" disabled="disabled" onchange="update_answer_question(this,\'' + type + '\',' + response.data.questionid + ','+response.data[0].questionboxdescriptionid+');" data-checked-descriptionid="'+response.data[0].questionboxdescriptionid+'" class="data_checked_descriptionid"/>';
            ...
            question_area += '<label><input onblur="update_question(this,\'' + type + '\',' + response.data.questionid + ');" type="text" data-box-descriptionid="' + response.data[0].questionboxdescriptionid + '" class="survey_input_box_description" value="<?php echo _l('pass'); ?>"></label>';
            question_area += '</div>';
            question_area += '</div>';
            question_area += '<div class="box_area">';
            question_area += '<div class="col-md-12">';
            ...
            question_area += '<label><input onblur="update_question(this,\'' + type + '\',' + response.data.questionid + ');" type="text" data-box-descriptionid="' + response.data[0].questionboxdescriptionid2 + '" class="survey_input_box_description"value="<?php echo _l('fail'); ?>"></label>';
            question_area += '</div>';
            question_area += '</div>';
            question_area += '</div>';
        } else {
