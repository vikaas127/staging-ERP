...
function remove_list_custom_field(field, fieldid) {
    if (typeof(fieldid) !== 'undefined') {
        $.get(admin_url + 'flexstage/remove_list_custom_field/' + fieldid, function(response) {
