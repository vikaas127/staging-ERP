...
class Estimate extends ClientsController
{
    public function index($id = '', $hash = '')
    {
        ...
        $data['all_discounts'] = $this->estimates_model->get_all_discounts(); // from tbldiscounts

if (isset($estimate)) {
    $data['estimate_applied_discounts'] = $this->estimates_model->get_applied_discount_ids('estimate', $estimate->id);
}
