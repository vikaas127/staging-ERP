...
$route['api/get-company-info'] = 'Settings/get_company_info';
...
$route['customerprofile/submit_customer_profile_form'] = 'CustomerProfile/submit_customer_profile_form';

// $route['GSTAPI/generateEInvoice'] = 'GSTAPI/generateEInvoice';
// $route['generate-einvoice'] = 'GSTAPI/generateEInvoice';

$route['invoices'] = 'invoices';
$route['invoices/create'] = 'invoices/create';
$route['invoices/save'] = 'invoices/save';
$route['invoices/generate_einvoice'] = 'invoices/generate_einvoice';

// GST API Routes
$route['gst/(:any)'] = 'gstapi/$1';
