...
widgetsOptionsHTML +=
    "<div class=\"tw-flex tw-space-x-4 tw-items-center\"><h3 class='tw-font-medium tw-text-neutral-600 tw-text-lg'><i class='fa-regular fa-circle-question' data-toggle='tooltip' data-placement=\"bottom\" data-title=\"<?php echo _l('widgets_visibility_help_text'); ?>\"></i> <?php echo _l('widgets'); ?></h3><a href=\"<?php echo admin_url('staff/reset_dashboard'); ?>\" class=\"tw-text-sm\"><?php echo _l('reset_dashboard'); ?></a>";

// Commented out the widgetable area link
// widgetsOptionsHTML += ' <a href=\"#\" id="viewWidgetableArea" class=\"tw-text-sm\"><?php echo _l('view_widgetable_area'); ?></a>';

widgetsOptionsHTML += '</div>';
...
$('.screen-options-area').append(widgetsOptionsHTML);  // Keep appending dashboard options
