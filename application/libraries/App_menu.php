...
class App_menu
{
    ...
    //hrms
    public function add_hrms_menu_item($slug, $item)
    {
        $this->add($slug, $item, 'hrms');

        return $this;
    }

    public function add_hrms_children_item($parent_slug, $item)
    {
        $this->add_child($parent_slug, $item, 'hrms');

        return $this;
    }

    public function get_hrms_menu_child_items($parent_slug)
    {
        return $this->get_child($parent_slug, 'hrms');
    }

    public function get_hrms_menu_items()
    {
        return $this->get('hrms');
    }
